...
angular
  ...
  .config(function($translateProvider) {
    ...
    $translateProvider.translations('en', {
      ...
      PowerBeam: 'The backhaul link from Alto Concepción all the way down to Parrita is created with a pair of PowerBeam AC 500s. These radios are 500mm in diameter and can transport up to 450Mbps.',
    ...
    .translations('es', {
      ...
      'Why a cooperative?': '¿Por qué una cooperativa?',
      coopWhy: 'Las cooperativas se formaron para tener acceso a los productos / servicios de otra forma no fácilmente accesibles. En los estados unidos, cooperativas eléctricas rurales fueron iniciadas por los agricultores en la década de 1930 para obtener los servicios de electricidad cuando las empresas privadas de servicios públicos se negaron a servir a las zonas rurales. Sociedades Cooperativas de Seguros se formaron en América a finales de 1700, permitiendo a las personas que trabajan para obtener el seguro de incendio a precios que podían permitirse. Uniones de crédito, o cooperativas financieras, se organizaron en el año 1900 para facilitar el acceso de los trabajadores a las cuentas de ahorro y crédito. Las cooperativas de comercialización agrícola (leche, ganado y cerdos) se organizaron a principios de 1800 para mejorar el acceso a los agricultores. La misma idea existe aún hoy en día.',
      ...
      PowerBeam: 'El enlace backhaul de Alto Concepción hasta el fondo a Parrita se crea con un par de "PowerBeam AC 500". Estas radios son de 500 mm de diámetro y pueden transportar hasta 450 Mbps.',
